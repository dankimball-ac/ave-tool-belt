...
export default function Signin() {
  ...
  if (status === 'success' && data !== undefined) {
    ...
    Cookies.set('token', data.token, { expires: oneDay })
  ...
  return (
    <Container component="main" maxWidth="xs">
      ...
      >
        <Box width={'50%'} marginBottom={'10px'}>
          <NextImage path="/images/avelogo.svg" alt="Avenue Consultants Toolbelt" />
        </Box>
        <Box component="form" onSubmit={handleSubmit} noValidate sx={{ mt: 1 }}>
          ...
          {/* <Button variant="outlined" sx={{ p: 1, mb: 1, mt: 1 }} fullWidth>
            <Box sx={{ width: '20px', height: '20px', mr: 1 }}>
              <NextImage
                path="/images/google-logo.png"
